                  ...
                  {({
                    ...
                    <Form dir="rtl" className="text-end">
                      <BootstrapForm.Group className="mb-3">
                        <BootstrapForm.Label className="fs-5" >البريد الإلكتروني للمشرف</BootstrapForm.Label>
                      ...
                      <BootstrapForm.Group className="mb-3">
                        <BootstrapForm.Label className="fs-5">كلمة المرور الخاصة بالمشرف</BootstrapForm.Label>
                        <BootstrapForm.Control
                          type="password"
                          name="password"
                ...
                <div className="text-center mt-3">
                  <p className="mb-1">
                    <Button
                      ...
                      onClick={() => navigate('/forgot-password-supervisor')}
                    >
                      هل نسيت كلمة المرور؟
                    </Button>
                  </p>
