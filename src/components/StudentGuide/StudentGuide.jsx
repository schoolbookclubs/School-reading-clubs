          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  <ul className='px-5'>
                    <li>تقام اجتماعات نادي القراءة شهريًا. يجتمع فيها أعضاء النادي ويناقشون كتبًا اختاروا قراءتها.</li>
                    <li>يتولى أحد أعضاء النادي إدارة جلسة المناقشة، وهذه فرصة لاكتساب مهارات القيادة وإدارة الحوار.</li>
                    <li>يشرف أمين المكتبة على لقاءات الطلبة ويقدم لهم الإرشاد والدعم.</li>
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  <ul className='px-5'>
                    <li><strong>تجعل القراءة ممتعة:</strong> تخرج أندية الكتب القراءة من الصف وتجعلها شيئًا يمكنك الاستمتاع به مع الأصدقاء. ستغوص في قصص مشوقة وتتحدث عما تحبه (أو لا تحبه!) حول هذه الكتب.</li>
                    <li><strong>تساعدك في تكوين صداقات:</strong> ستلتقي بأشخاص جدد يشاركونك اهتمامك بالكتب. هذه الصداقات يمكن أن تنمو من خلال تجارب القراءة المشتركة والمناقشات الممتعة.</li>
                    <li><strong>تعزز مهارات القراءة لديك:</strong> مع المزيد من القراءة، تتحسن مفرداتك وفهمك وقدراتك التحليلية بشكل طبيعي. بالإضافة إلى ذلك، ستمنحك مناقشة الكتب مع الآخرين رؤى جديدة وتساعدك على التفكير بعمق.</li>
                    <li><strong>استكشاف كتب متنوعة:</strong> سواء من الكتب التي ستقرؤها أو من الاستماع إلى آراء زملائك في النادي، ستتعرف على وجهات نظر مختلفة وتطّلع على أنواع كتب جديدة، ومنها ستتمكن من اختيار الأنسب لك وتكوّن ذوقك الأدبي الخاص.</li>
                    <li><strong>تحسين مهارات التواصل:</strong> مشاركة أفكارك في المناقشات يمنحك أريحية في التحدث أمام الآخرين وشرح أفكارك بوضوح.</li>
                    <li><strong>زيادة الثقة بالنفس:</strong> التحدث عن الكتب في مجموعة يعزز ثقتك بنفسك وقدرتك على إيصال وجهة نظرك.</li>
                    <li><strong>المشاركة في أنشطة مسلية:</strong> أندية الكتب تنظم أحيانًا فعاليات مبتكرة كالمشاريع الإبداعية واللقاءات مع المؤلفين، وتعرفك على الأفلام المرتبطة بالكتب التي قرأتها.</li>
                    <li><strong>تعزيز الإبداع والخيال:</strong> القراءة تُشعل خيالك، ومناقشات أندية الكتب تتيح لك فرصة استكشاف أفكار إبداعية مختلفة.</li>
                  </ul>
                </Card.Text>
              </Card.Body>
            </Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  <ul className='px-5'>
                    ...
                    <li>ستطرح قوائم بالكتب من مختلف ميادين الثقافة والأدب.</li>
                    <li>ستختار مع زملائك في النادي الكتب الشهرية التي ستناقشونها عن طريق القرعة أو التصويت.</li>
                  </ul>
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  <ul className='px-5'>
                    <li><strong>أسئلة تثير التفكير:</strong> خلال المناقشات، ستستكشف أسئلة مثل "لماذا قامت الشخصية بهذا التصرف؟" أو "ماذا كنت ستفعل في هذا الموقف؟" تساعدك على التفكير بعمق حول القصة والشخصيات.</li>
                    <li><strong>احترام الآراء المختلفة:</strong> كل شخص لديه أفكاره وآراؤه الخاصة، وهذا ما يجعل المناقشات مثيرة! ستكتسب احترام وجهات نظر الآخرين ورؤية الكتاب من زوايا جديدة.</li>
                    <li><strong>المرح والضحك:</strong> المناقشات ليست جادة دائمًا - هناك مساحة كبيرة للمرح والنكات وحتى النقاشات الخفيفة حول الأجزاء المفضلة (أو الأقل تفضيلاً) من الكتاب.</li>
                  </ul>
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  <ul className='px-5'>
                    <li><strong>التزم بجدول القراءة:</strong> الالتزام بجدول القراءة يساعدك على المساهمة في المحادثات والاندماج مع المجموعة.</li>
                    <li><strong>تدوين الملاحظات أثناء القراءة:</strong> دوّن أفكارك أو أسئلتك أثناء القراءة. سيجعل ذلك المناقشات أكثر إثارة، وستجد الكثير لمشاركته.</li>
                    <li><strong>حضّر بطاقة تقييم الكتاب:</strong> بعد إتمام قراءة الكتاب اكتب رأيك في بطاقة تقييم الكتاب، شارك آرائك أثناء الاجتماع بقراءة تقييمك أو التعبير الحر عن أفكارك.</li>
                  </ul>
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  <ul className='px-5'>
                    <li><strong>كن منفتحًا على الكتب الجديدة:</strong> حتى لو لم يكن الكتاب يبدو كاختيارك المعتاد، جربه. قد تتفاجأ بمدى استمتاعك به!</li>
                    <li><strong>شارك بفاعلية:</strong> سواء كنت تطرح أسئلة، أو تجيب عليها، أو تستمع بانتباه، فإن مشاركتك تجعل النادي ممتعًا للجميع. لا توجد إجابة صحيحة أو خاطئة، ورأيك له قيمة.</li>
                    <li><strong>تقبّل وجهات النظر:</strong> حتى لو لم تتفق مع رأي شخص ما، فإن الاستماع واحترام وجهة نظره يساعد في خلق بيئة ودية ومنفتحة.</li>
                    <li><strong>المساهمة بأفكار إبداعية:</strong> تحدث عما أعجبك في الكتاب، أو ما فاجأك، أو ما لم يكن واضحًا بالنسبة لك. كل مساهمة تضيف إلى إثراء النقاش.</li>
                    <li><strong>استمتع!</strong> أندية الكتب تهدف إلى المتعة. سواء كنت تناقش تطور الحبكة أو تضحك على شخصية مضحكة، كل ذلك جزء من التجربة.</li>
                  </ul>
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  <ul className='px-5'>
                    <li>يحدد مدير للجلسة من أحد الطلاب ليطرح أسئلة ويدير الحوار بين المشاركين.</li>
                    <li>يدون الطلاب تقييمهم للكتاب قبل الاجتماع بملء بطاقة تقييم الكتاب ويشاركون بعرض آرائهم أثناء الاجتماع.</li>
                    <li>يقدم المشرف التربوي الدعم لمدير الجلسة قبل الاجتماع بمراجعة الأسئلة والمحاور التي أعدها لإدارة الاجتماع.</li>
                    <li>ييسر المشرف التربوي الحوار أثناء الاجتماع بدعم مدير الجلسة وتشجيع الحضور على المشاركة الفاعلة.</li>
                    <li>يمكن دعوة أولياء الأمور لبعض الجلسات كنشاط مصاحب ما بعد المناقشة.</li>
                  </ul>
                </Card.Text>
              </Card.Body>
            </Card>
            ...
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  <ul className='px-5'>
                    <li>تقييم الطلاب الذاتي</li>
                    <li>تقييم الطلاب للكتاب</li>
                  </ul>
            ...
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  <ul className='px-5'>
                    <li><strong>اختيار الكتب:</strong> إن لم يعجبك الكتاب، ابحث عن مصادر تلخص هذا الكتاب، قد تجد فيه فائدة لم تكن تتوقعها، ربما تجد فيلمًا مقتبسًا عن قصة الكتاب، أو تسجيل بودكاست، أو ملخص مرئي. بعض الكتب كالدواء المر الذي نتناوله لنتقوى.</li>
                    <li><strong>الشعور بالإحراج:</strong> من فوائد أندية القراءة هي توفير بيئة آمنة للتعبير والمشاركة، كل زملائك في نفس مستواك وكل واحد منكم يشجع الآخر، استغل هذه الفرصة للتجاوز الخوف فلا توجد أحكام أو طريقة واحد صحيحة للتفكير.</li>
                    <li><strong>الشعور بالملل:</strong> خذ فترات للراحة، واجعل لك طقوسًا للقراءة تزيد من متعتها، كأن توفر إضاءة مناسبة، وجوًا معتدلًا مع كوب من مشروبك الدافئ المفضل. تحدث مع أصدقائك عن رأيك المبدئي قبل الاجتماع وأين وصلت في القراءة، وربما تحددون سباقًا بينكم لمن ينهي الكتاب أولًا، ومن يلاحظ أكبر عدد من الملاحظات الجديدة.</li>
                  </ul>
                </Card.Text>
              </Card.Body>
            </Card>
