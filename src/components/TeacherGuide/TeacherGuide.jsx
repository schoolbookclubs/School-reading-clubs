...
const TeacherGuide = () => {
  ...
  return (
    <div className="teacher-guide">
      <Container>
        <div className="guide-header text-center my-5">
  ...
  <Col>
    <Card>
      <Card.Body>
        ...
        <Card.Text>
          <ul className='px-5'>
            <li>الإعلان عن البرنامج وفتح باب التسجيل فيه للطلاب.</li>
            <li>دعوة أولياء الأمور لحضور الجلسة التوعية بأندية القراءة.</li>
            <li>دعوة الطلاب لحضور الندوة التعريفية بأندية القراءة.</li>
            <li>استقبال طلبات التسجيل من الطلاب واختيار المشاركين في البرنامج.</li>
            <li>عقد اجتماع افتتاح نادي القراءة والتعريف بأنواع الكتب والقوائم المتاحة.</li>
            <li>تحديد موعد للاجتماع الأول واختيار كتاب لمناقشته.</li>
            <li>استلام الطلاب للكتاب.</li>
            <li>عقد الاجتماع الأول.</li>
            <li>في كل اجتماع يتم تحديد الكتاب الذي سيناقش في الجلسة التالية.</li>
          </ul>
        </Card.Text>
      </Card.Body>
    </Card>
  ...
  <Col>
    <Card>
      <Card.Body>
        ...
        <Card.Text>
          <ul className='px-5'>
            <li>تعريف الطلاب بالكتب الملائمة لميولهم ومستوياتهم القرائية ومساعدتهم في عملية اختيار الكتاب.</li>
            <li>تحفيز الطلاب أثناء المناقشة على المشاركة بآرائهم والاستماع إلى آراء زملائهم وتوسيع دائرة التفكير والتحليل.</li>
            <li>ربط مادة الكتاب بأمثلة من الحياة والمنهج الدراسي.</li>
            <li>توفير مواد قرائية إضافية للطلاب الراغبين بتوسيع قراءاتهم.</li>
            <li>تعريف الطلاب بكتب متنوعة المجالات والأساليب والثقافات.</li>
            <li>إعداد مكان الاجتماع وابتكار أنشطة مساندة للقراءة والمناقشة لإضفاء جو من العفوية والصداقة.</li>
            <li>تقديم التوجيه للطلاب في حال الحاجة ودعمهم لتحصيل أعلى فائدة ومتعة من المشاركة.</li>
          </ul>
        </Card.Text>
      </Card.Body>
    </Card>
  ...
  <Col>
    <Card>
      <Card.Body>
        ...
        <Card.Text>
          <ul className='px-5'>
            <li>اختيار موعد دائم لعقد الاجتماعات (يوم ووقت محدد من كل شهر).</li>
            <li>الحرص على أن يكون الوقت كافيًا ليتمكن الطلاب من قراءة الكتاب قبل المناقشة.</li>
            <li>توفير بعض المرونة لمراعاة الفروقات في قدرات المشاركين.</li>
          </ul>
        </Card.Text>
      </Card.Body>
    </Card>
      ...
      <Card.Body>
        ...
        <Card.Text>
          <ul className='px-5'>
            ...
            <li>يدون الطلاب تقييمهم للكتاب قبل الاجتماع بملء بطاقة تقييم الكتاب.</li>
  ...
  <Col>
    <Card>
      <Card.Body>
        ...
        <Card.Text>
          <ul className='px-5'>
            <li>مساعدة مدير الجلسة على إعداد أسئلة هادفة تشجع المشاركين على التفكير النقدي والحوار.</li>
            <li>خلق بيئة آمنة ترحب بالحضور وتحفزهم على إبداء آرائهم.</li>
            <li>احترام وجهات النظر أثناء النقاش.</li>
            <li>تشجيع الطلاب الذين يميلون إلى الاستماع للمشاركة في المناقشة وحث المتحدثين على الإصغاء لأقرانهم.</li>
          </ul>
        </Card.Text>
      </Card.Body>
    </Card>
  ...
  <Col>
    <Card>
      <Card.Body>
        ...
        <Card.Text>
          <ul className='px-5'>
            <li>تشجيع الطلاب على أخذ زمام القيادة وتعزيز ثقتهم بمشاركاتهم.</li>
            <li>تنويع وسائل التعلم المساندة كاستخدام التكنولوجيا (الكتب الالكترونية، الصوتية، والمواد التفاعلية).</li>
            <li>بناء علاقة ودية مع الطلاب بحيث تكون مرجعًا للاستفسار والاستزادة.</li>
            <li>تعريف الطلاب على المكتبات في المدينة، وإن أمكن التنسيق لزيارة إحدى المكتبات.</li>
            <li>إبقاء الوالدين على اطلاع بأنشطة النادي وتحفيزهم على مشاركة أبنائهم قراءة الكتب ومناقشتها معهم في المنزل.</li>
          </ul>
        </Card.Text>
      </Card.Body>
    </Card>
    ...
    <Card>
      <Card.Body>
        ...
        <Card.Text>
          ...
          <ul className='px-5'>
            <li>تقييم المشرف التربوي للطلاب.</li>
      ...
      <Card.Body>
        ...
        <Card.Text>
          ...
          <ul className='px-5'>
            <li>عدد المدارس</li>
            <li>عدد الطلاب</li>
            <li>عدد الكتب المقروءة</li>
            <li>عدد المواضيع</li>
            <li>معدل حضور الطلاب</li>
          </ul>
          <h5 className="mt-3">مؤشرات قياس الأداء النوعية</h5>
          <ul className='px-5'>
            <li>تصميم استبيانات تقييس تطور الطلاب في النواحي التالية:</li>
            <ul>
              <li>مهارات التفكير</li>
              <li>المهارات الاجتماعية</li>
              <li>المهارات اللغوية</li>
              <li>السلوك العام</li>
            </ul>
          </ul>
    ...
    <Card>
      <Card.Body>
        ...
        <Card.Text>
          ...
          <ul className='px-5'>
            <li>تشجيع النقاشات الأدبية: طرح الأسئلة المفتوحة وتوجيه النقاش نحو استكشاف الأفكار الرئيسية في الكتب.</li>
            <li>تحفيز التفكير النقدي: تشجيع الطلاب على التعبير عن آرائهم الشخصية وتحليل النصوص الأدبية.</li>
            <li>المشاركة الفعالة: مشاركة المدرسين في القراءة والنقاش لتكون قدوة إيجابية للطلاب.</li>
            <li>تنظيم الأنشطة: تنظيم أنشطة تفاعلية مثل العروض التقديمية أو ورش العمل التي تعزز حب القراءة.</li>
            <li>تحسين الفهم والاستيعاب: تحفيز الطلاب على التفكير بعمق حول ما يقرؤونه.</li>
            <li>بناء الثقة بالنفس: توفير مساحة آمنة للطلاب للتعبير عن آرائهم.</li>
          </ul>
        </Card.Text>
      </Card.Body>
    </Card>
